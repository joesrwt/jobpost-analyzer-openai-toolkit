...
- "Company Characteristics": A summary of the key traits or qualities the company is seeking in a candidate, such as work ethic, personality traits, or professional qualities.

Example output:
{
    "Technical Skills": ["Python", "Machine Learning", "Data Analysis", "SQL"],
    "Soft Skills": ["Collaboration", "Adaptability", "Communication"],
    "Company Characteristics": ["Proactive", "Innovative", "Team-oriented"]
}
"""

# Input 2: Mock behavioral interview question
mock_interview_prompt = """
Based on the technical skills, soft skills, and company characteristics extracted from the LinkedIn job post, generate 3 example behavioral interview questions.
Questions should help the candidate prepare for real-life scenarios based on the job requirements.
"""

# Display text area for mocking behavioral interview questions
st.markdown("### 🗨️ Mock Behavioral Interview Questions")
behavioral_questions_input = st.text_area(
    "AI-generated behavioral interview questions for this role will appear here. Use this box to customize or write new ones!",
    placeholder="E.g. Can you share an example of how you successfully collaborated with a team to overcome a challenge?",
    height=150,
)
...
if st.button("🚀 Analyze & Generate Insights"):
    if not user_api_key:
        ...
        try:
            ...
            company_characteristics = insights.get("Company Characteristics", [])
            ...
            df_insights = pd.DataFrame({
                ...
                "Company Characteristics": [", ".join(company_characteristics)],
            })
